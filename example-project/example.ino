...
void ui_create() {
  ...
  lv_label_set_text(title, "AIR QUALITY MONITORING");                    // Isi teks judul
  ...
  lv_obj_align(aqi_container, LV_ALIGN_LEFT_MID, 5, 18);              // Posisikan di kiri tengah
  ...
  int card_w = 82, card_h = 60, start_x = 143, start_y = 40, gap = 8; // Ukuran & posisi kartu
