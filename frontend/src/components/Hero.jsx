...
import { MapPin, Cloud, Droplets, Wind, Sun, TrendingUp, Sparkles, ChevronRight } from "lucide-react";
...
const res = await fetch(`${API_URL}/data`);
  ...
  if (currentView === "detail" && selectedSensor) {
    return <SensorDetail sensorType={selectedSensor} onBack={handleBackToDashboard} />;
  }
          ...
          <div className="glass-effect rounded-2xl sm:rounded-3xl p-6 sm:p-8 md:p-10 shadow-2xl animate-slide-in" style={{animationDelay: '0.3s'}}>
            <div className="text-center mb-6 sm:mb-8">
              ...
              <p className="text-slate-400 text-xs sm:text-sm px-4">
                Panduan memahami tingkat kualitas udara berdasarkan konsentrasi polutan
              </p>
            </div>
            ...
            <div className="mt-6 sm:mt-8 text-center px-4">
              <p className="text-slate-400 text-xs sm:text-sm leading-relaxed max-w-3xl mx-auto">
                Skala AQI (Air Quality Index) mengklasifikasikan kualitas udara dari level 1 (Baik) hingga 5 (Berbahaya).
