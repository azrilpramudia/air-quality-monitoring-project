...
import { MapPin, Droplets, Wind, Eye, TrendingUp, TrendingDown, Clock } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-slate-500">Pemantauan Kualitas Udara Real-Time</p>
            </div>
          </div>
          <div className="flex items-center space-x-2 text-slate-600">
            <Clock className="h-5 w-5" />
            <span className="text-sm">Terakhir Diperbarui: {currentTime.toLocaleTimeString('id-ID')} WIB</span>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-slate-200 overflow-hidden mb-8">
          <div className="grid md:grid-cols-2 gap-0">
            ...
            <div className="bg-gradient-to-br from-slate-50 to-white p-8 md:p-12 flex flex-col justify-center items-center border-r border-slate-200">
              <div className={`w-40 h-40 ${aqiColor} rounded-full flex items-center justify-center shadow-lg mb-4`}>
                <div className="text-center">
                  <div className="text-5xl font-bold text-white">{aqiValue}</div>
                  <div className="text-sm font-semibold text-white mt-1">AQI</div>
                </div>
              </div>
              <h2 className="text-3xl font-bold text-slate-800 mb-2">{aqiStatus}</h2>
            ...
            <div className="p-8 md:p-12 bg-white">
              <h3 className="text-lg font-bold text-slate-800 mb-6">Data Lingkungan Saat Ini</h3>
                ...
                <div className="flex items-center justify-between p-4 bg-slate-50 rounded-lg">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-lg font-bold text-slate-800">32 µg/m³</p>
                    </div>
                  </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <div className="bg-white rounded-xl p-6 shadow-md border-l-4 border-blue-500 hover:shadow-lg transition-shadow">
            ...
            <p className="text-sm text-slate-600 mb-3">Sensor Suhu & Kelembaban</p>
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                <span className="text-xs text-slate-500">Suhu</span>
                <span className="text-sm font-semibold text-slate-800">28.5°C</span>
              </div>
              <div className="flex justify-between items-center">
          ...
          <div className="bg-white rounded-xl p-6 shadow-md border-l-4 border-cyan-500 hover:shadow-lg transition-shadow">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                <span className="text-xs text-slate-500">Suhu</span>
                <span className="text-sm font-semibold text-slate-800">28.3°C</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-xs text-slate-500">Kelembaban</span>
                <span className="text-sm font-semibold text-slate-800">73%</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl p-6 shadow-md border-l-4 border-purple-500 hover:shadow-lg transition-shadow">
            ...
            <p className="text-sm text-slate-600 mb-3">Sensor Debu & Partikel</p>
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                <span className="text-xs text-slate-500">PM2.5</span>
                <span className="text-sm font-semibold text-slate-800">32 µg/m³</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-xs text-slate-500">PM10</span>
                <span className="text-sm font-semibold text-slate-800">45 µg/m³</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl p-6 shadow-md border-l-4 border-green-500 hover:shadow-lg transition-shadow">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                ...
                <span className="text-sm font-semibold text-slate-800">125 ppb</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-xs text-slate-500">eCO2</span>
                <span className="text-sm font-semibold text-slate-800">420 ppm</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl p-6 shadow-md border border-slate-200">
          <h3 className="text-lg font-bold text-slate-800 mb-4">Skala Indeks Kualitas Udara</h3>
          <div className="grid grid-cols-2 md:grid-cols-6 gap-3">
            <div className="text-center p-3 bg-green-50 rounded-lg border-2 border-green-400">
              ...
              <div className="text-xs font-semibold text-green-700 mt-1">Baik</div>
            </div>
            <div className="text-center p-3 bg-yellow-50 rounded-lg border-2 border-yellow-400">
              ...
              <div className="text-xs font-semibold text-yellow-700 mt-1">Sedang</div>
            </div>
            <div className="text-center p-3 bg-orange-50 rounded-lg border-2 border-orange-400">
              ...
              <div className="text-xs font-semibold text-orange-700 mt-1">Tidak Sehat</div>
            </div>
            <div className="text-center p-3 bg-red-50 rounded-lg border-2 border-red-400">
              ...
              <div className="text-xs font-semibold text-red-700 mt-1">Sangat Tidak Sehat</div>
            </div>
            <div className="text-center p-3 bg-purple-50 rounded-lg border-2 border-purple-400">
              ...
              <div className="text-xs font-semibold text-purple-700 mt-1">Berbahaya</div>
            </div>
            <div className="text-center p-3 bg-rose-50 rounded-lg border-2 border-rose-600">
              ...
              <div className="text-xs font-semibold text-rose-700 mt-1">Sangat Berbahaya</div>
            </div>
          </div>
        </div>
export default Hero;